	    ...
	    var infoWindowContent = [
	        ['<div class="property-listing-map-info-window">' +
	            '<div class="image-with-label">' +
	                '<img src="images/map_image.jpg" alt="featured-properties-1" class="img-responsive">' +
	                '<label>On Sale</label>' +
	            '</div>' + 
	        ...
	        ['<div class="property-listing-map-info-window">' +
	            '<div class="image-with-label">' +
	                '<img src="images/map_image.jpg" alt="featured-properties-2" class="img-responsive">' +
	                '<label>On Sale</label>' +
	            '</div>' + 
	            '<div class="featured-properties-detail"> ' +
	                '<a href="#"><h4>Luxury Family Home</h4></a> ' +
	            ...
	            ['<div class="property-listing-map-info-window">' +
	            '<div class="image-with-label">' +
	                '<img src="images/map_image.jpg" alt="featured-properties-3" class="img-responsive">' +
	                '<label>On Sale</label>' +
	            '</div>' + 
	            '<div class="featured-properties-detail"> ' +
	                '<a href="#"><h4>Luxury Family Home</h4></a> ' +
	            ...
	            ['<div class="property-listing-map-info-window">' +
	            '<div class="image-with-label">' +
	                '<img src="images/map_image.jpg" alt="featured-properties-4" class="img-responsive">' +
	                '<label>On Sale</label>' +
	            '</div>' + 
	           '<div class="featured-properties-detail"> ' +
	                '<a href="#"><h4>Luxury Family Home</h4></a> ' +
	            ...
	            ['<div class="property-listing-map-info-window">' +
	            '<div class="image-with-label">' +
	                '<img src="images/map_image.jpg" alt="featured-properties-5" class="img-responsive">' +
	                '<label>On Sale</label>' +
	            '</div>' + 
	            '<div class="featured-properties-detail"> ' +
	                '<a href="#"><h4>Luxury Family Home</h4></a> ' +
	            ...
	            ['<div class="property-listing-map-info-window">' +
	            '<div class="image-with-label">' +
	                '<img src="images/map_image.jpg" alt="featured-properties-6" class="img-responsive">' +
	                '<label>On Sale</label>' +
	            '</div>' + 
	            '<div class="featured-properties-detail"> ' +
	                '<a href="#"><h4>Luxury Family Home</h4></a> ' +
